...
export function AIPanel() {
  ...
  const [prompt, setPrompt] = useState("'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            The toolbar is currently only a visual UI.\n\n\n\nPlease fix the toolbar so every tool is fully functional.\n\n\n\nRequirements:\n\n\n\n- Clicking a tool changes the active tool.\n\n- Only one tool can be active at a time.\n\n- Active tool is highlighted with the purple background.\n\n- Cursor changes according to the selected tool.\n\n- The selected tool is synchronized with the canvas.\n\n- Use Zustand as the single source of truth.\n\n- Do not use local component state.\n\n- Connect every toolbar button to the editor.\n\n\n\nImplement these tools:\n\n\n\n- Select\n\n- Text\n\n- Rectangle\n\n- Circle\n\n- Arrow\n\n- Sticky Note\n\n- Image\n\n- Video\n\n- PDF\n\n\n\nWhen a tool is selected, clicking on the canvas creates that object.\n\n\n\nPressing ESC returns to Select mode.\n\n\n\nDouble-clicking Text immediately enters editing mode.\n\n\n\nThe toolbar should stay synchronized with the editor even when the tool is changed via keyboard shortcuts.\n\n\n\nRefactor the toolbar if necessary but preserve the current UI.");
